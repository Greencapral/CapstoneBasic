...
def test_chromedriver():
    ...
    try:
        ...
        if "Google" in driver.title:
            ...
            print("⚠️  Браузер открылся, но страница не та.")
        ...
        print("  - Совпадают ли версии Chrome и ChromeDriver?")
        print("  - Добавлен ли ChromeDriver в PATH или указан ли путь в коде?")
